            ...
            <tr class="hover:bg-gray-50 group">
                ...
                <td class="px-6 py-3 whitespace-nowrap">
                    ...
                    <button  data-modal-target="modal-delete-{{$promotion->id}}"  data-modal-toggle="modal-delete-{{$promotion->id}}" class="mx-2"><i class="fa-solid fa-undo text-red-600 hover:text-red-500 fa-lg"></i></button>
                                                ...
                                                <!-- Delete modal -->
                            <div wire:key='{{$promotion->id}}' id="modal-delete-{{$promotion->id}}"  aria-hidden="true" class="fixed top-0 left-0 right-0 z-990 hidden max-md:w-screen max-md:h-screen md:py-[15%] md:px-[32%] overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
