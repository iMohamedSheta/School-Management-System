...
<div class="container">
    @if ($currentStep === 1)
        {{-- <!-- Step 1 form -->
        <form wire:submit.prevent="submitStep1Form">
            <input type="text" wire:model.defer="step1Data.field1">
            <input type="text" wire:model.defer="step1Data.field2">
        ...
        <div class="pb-14 pt-7 flex">
            ...
            <div class="w-full sm:max-w-md lg:max-w-xl mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg mx-auto">
                    ...
                    <form method="POST" wire:submit.prevent="submitStep1Form" >
                        @csrf
...
{{--
    ...
    @elseif ($currentStep === 2)
        <!-- Step 2 form -->
        <form wire:submit.prevent="submitStep2Form">
            <input type="text" wire:model.defer="step2Data.field3">
            <input type="text" wire:model.defer="step2Data.field4">
            <button type="button" wire:click="goToStep(1)">Previous</button>
