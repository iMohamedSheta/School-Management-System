...
<x-dialog-modal wire:model="openModal"  >
    <x-slot name="title">
    {{ trans('main.edit_processingfee',['name'=>$processingfee->student->name]) }}
    </x-slot>

    <x-slot name="content">
                <div class="pb-2 pt-8 w-full {{in_array(app()->getLocale(),['ar']) ? "text-right" : "text-left" }}" >

            <form wire:submit.prevent="updateProcessingFee" method="post">
                @csrf
    ...
    <x-slot name="footer">
        ...
        ease-in-out duration-150'" wire:click="updateProcessingFee" wire:loading.attr="disabled">
