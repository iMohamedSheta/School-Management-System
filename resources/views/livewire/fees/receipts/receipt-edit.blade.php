...
<x-dialog-modal wire:model="openModal"  >
    <x-slot name="title">
    {{ trans('main.edit_receipt',['name'=>$receipt->student->name]) }}
    </x-slot>

    <x-slot name="content">
                <div class="pb-10 pt-2 w-full {{in_array(app()->getLocale(),['ar']) ? "text-right" : "text-left" }}" >

                    <form wire:submit.prevent="editReceipt" method="post">
                        @csrf
    ...
    <x-slot name="footer">
        ...
        ease-in-out duration-150'" wire:click="editReceipt" wire:loading.attr="disabled">
