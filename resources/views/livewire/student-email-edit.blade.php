    ...
    <div>
        <div href="#" class="block max-w-lg p-6 mt-4  bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
            <div class="flex justify-center mb-2 items-center">
                ...
                <h5 class=" text-md font-bold tracking-tight text-gray-900 dark:text-white"> {{ trans('main.student-edit-email-title',['name'=> $student_user->student->name]) }} </h5>
            </div>
        <p class="font-normal text-gray-700 dark:text-gray-400">{{ trans('main.student-edit-email-body',['name'=> $student_user->student->name]) }}</p>
    </div>
