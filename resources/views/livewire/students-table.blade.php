        ...
        @forelse ($students as $student)
            <tr class="hover:bg-gray-50">
                ...
                <td class=" py-3 whitespace-nowrap text-center  absolute">
                    <div class="relative hide-on-loading"  x-data="{ dropdownOpen: false }">
                        ...
                        <div class="absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white z-10"
                            ...
                            <a href="{{route('student.info',$student->id)}}" target="_blank" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"><i class="mx-2 fa-solid fa-file-lines fa-lg hover:text-gray-800"></i>{{ trans('main.student-info-dropdown') }}</a>
                            ...
                            <div x-data="{ showModal: false }">
                                <button class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 w-full" x-on:click="showModal = true" ><i class="mx-2 fa-solid fa-trash text-red-600 hover:text-red-500 fa-lg"></i>{{ trans('main.delete-student-dropdown') }}
                                </button>
                                    <!-- Delete modal -->
                    ...
                    <script>
                        window.addEventListener('load', function() {
                            var dropdownContainers = document.getElementsByClassName('hide-on-loading');
...
<div class="mt-4">
 ...
 <!-- DeleteAll modal -->
 <div id="modal-deleteAll" tabindex="-1" wire:ignore aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden max-md:w-screen max-md:h-screen p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
