        ...
        @forelse ($students as $student)
            <tr>
                ...
                <td class="px-6 py-3 whitespace-nowrap flex justify-center ">
                    <a href="{{route('student.info',$student->id)}}" class="mx-4">
                        <i class="fa-solid fa-file-lines fa-lg hover:text-gray-800"></i>
                    </a>
                    <button  data-modal-target="grade-modal{{$student->id}}"   data-modal-toggle="grade-modal{{$student->id}}"
                    onclick="document.getElementById('edit-classroom-id').value = '{{ $student->id }}';"
                        class="mx-4">
                        <i class="fa-sharp fa-solid fa-pen-to-square fa-lg hover:text-gray-800"></i>
                    </button>
                    <button  data-modal-target="modal-delete-{{$loop->iteration}}"  data-modal-toggle="modal-delete-{{$loop->iteration}}" class="mx-4 my-1"><i class="fa-solid fa-trash text-red-600 hover:text-red-500 fa-lg"></i></button>
                    ...
                    <div class="relative w-full h-full max-w-md md:h-auto">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 ">
                            ...
                            <div class="p-6 text-center">
                                ...
                                <button data-modal-hide="modal-delete-{{$loop->iteration}}" type="submit"   id="delete-selected-btn" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                    {{trans('main.confirm')}}
                                </button>
