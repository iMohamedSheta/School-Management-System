<x-form-section submit="updatePassword">
    <x-slot name="title">
        {{ trans('profile.update-password') }}
    </x-slot>

    <x-slot name="description">
        {{ trans('profile.secure-password') }}
    </x-slot>

    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-label for="current_password" value="{{ trans('profile.current-password') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password" value="{{ trans('profile.new-password') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password_confirmation" value="{{ trans('profile.confirm-password') }}" />
