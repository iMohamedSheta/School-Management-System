        ...
        <div class="relative w-full h-full max-w-md md:h-auto " >
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="space-y-6" action="{{route('grade.create')}}" method="post">
                        @csrf
                        <div>
                            <label for="gradename" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ trans('main.grade-name') }}</label>
                            <input type="text" name="name" id="gradename" class="@error('name') is-invalid @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{old('name')}}" >
                        </div>
                        <div>
