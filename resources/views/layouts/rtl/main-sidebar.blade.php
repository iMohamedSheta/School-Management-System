...
<aside id="aside" class="fixed  inset-y-0 right-0 flex-wrap  items-center justify-between inline-block fs:bg-white p-0 my-4 dash-translate-x-full duration-200 xs:bg-white border-0 shadow-none dark:bg-gray-950 ease-soft-in-out z-10 xl:mr-4 rounded-2xl xl:translate-x-0 xl:bg-transparent ps ps__rtl ps--active-y max-w-64 overflow-y-auto ">
    ...
    <div class="h-19.5 " >
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="{{route('master')}}" target="_blank">
            ...
            <div id="sidebariconOnly1" class="inline-flex">
            ...
            <ul class="flex flex-col pl-0 mb-0 max-w-64 overflow-y-auto max-h-[calc(100vh-8rem)] " >
                ...
                <li class="w-full mt-2 ">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors font-semibold text-slate-700
                        ...
                        <div id="sidebariconOnly3">  <span class="mr-1 duration-300 opacity-100 pointer-events-none ease-soft">{{trans("main-sidebar.profile")}}</span></div>
                    </a>
                </li>
                <li class="w-full mt-2 ">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors font-semibold text-slate-700
                        ...
                        <div id="sidebariconOnly4"><span class="mr-1 duration-300 opacity-100 pointer-events-none ease-soft">{{trans("main-sidebar.posts.index")}}</span></div>
                    </a>
                </li>
                ...
                <li class="w-full mt-2 ">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors font-semibold text-slate-700
                        ...
                        <div id="sidebariconOnly10">  <span class="mr-1 duration-300 opacity-100 pointer-events-none ease-soft">{{trans("main-sidebar.grades")}}</span></div>
                    </a>
                </li>
                ...
                <li class="w-full mt-2  listopennavbar" >
                    <a  id="listopennavbar" aria-controls="data-accordion-icon1" data-collapse-toggle="data-accordion-icon1" class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center
                        whitespace-nowrap px-4 transition-colors font-semibold text-slate-700 {{  in_array(Route::currentRouteName(), ['register','users']) ? 'shadow-soft-xl rounded-lg bg-white' : '' }}"
                        href="#">
                        <div
                        class="{{ in_array(Route::currentRouteName(), ['register','users']) ? 'bg-gradient-to-tl from-purple-700 to-pink-500' : '' }} shadow-soft-2xl ml-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <i class="fa-solid fa-users-gear {{  in_array(Route::currentRouteName(), ['register','users']) ?'text-white' : ''}}"></i>
                        </div>
                        <div id="sidebariconOnly13"> <span class="mr-1 duration-300 opacity-100 pointer-events-none ease-soft">{{trans("main-sidebar.users")}}</span>
                        ...
                        <ul  id="data-accordion-icon1" class="hidden px-4">
                            <div class="border-r-2 border-gray-400 ">
                                ...
                                <li class="w-full mt-2 ">
                                    <a aria-controls="dropdown-example" data-collapse-toggle="dropdown-example" class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center
                                    whitespace-nowrap px-4 transition-colors font-semibold text-slate-700 {{ (Route::currentRouteName()== 'register') ? 'shadow-soft-xl rounded-lg bg-white' : '' }}"
                                        href="{{ route('register') }}">
                                        <div
                                        class="{{ Route::currentRouteName() == 'register' ? 'bg-gradient-to-tl from-purple-700 to-pink-500' : '' }} shadow-soft-2xl ml-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                                        <i class="fa-solid fa-user-pen {{ Route::currentRouteName() == 'register' ? 'text-white' : ''}}"></i>
                                        </div>
                                        <div id="sidebariconOnly11"> <span class="mr-1 duration-300 opacity-100 pointer-events-none ease-soft">{{trans("main-sidebar.register")}}</span></div>
                                    </a>
                                </li>
                            </div>
                        </ul>
    ...
    {{-- ------------------------------------------------------------------------------------------------------------------------------------- --}}
                    ...
                    <li class="listopennavbar w-full mt-2 " id="listopennavbar" >
                        <a  aria-controls="data-accordion-icon" data-collapse-toggle="data-accordion-icon" class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center
                            ...
                            <div id="sidebariconOnly7"> <span class=" mr-1 duration-300 opacity-100 pointer-events-none ease-soft">{{trans("main-sidebar.parent")}}</span>
                                <i  id="arrowicon" class="arrowicon fa-solid fa-chevron-down px-3  shrink-0 transition-transform duration-200"></i>
                            </div>
                            </a>
                            ...
                            <ul  id="data-accordion-icon" class="hidden px-4">
                                ...
                                <li class="w-full mt-2 ">
                                    ...
                                    whitespace-nowrap px-4 transition-colors font-semibold text-slate-700 {{ (Route::currentRouteName()== 'parent.index') ? 'shadow-soft-xl rounded-lg bg-white' : '' }}"
                                        ...
                                        <div id="sidebariconOnly5"> <span class="mr-1 duration-300 opacity-100 pointer-events-none ease-soft">{{trans("main-sidebar.parent")}}</span></div>
                                    </a>
                                </li>
                                <li class="w-full mt-2 ">
                                    <a aria-controls="dropdown-example" data-collapse-toggle="dropdown-example" class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center
